...
public class Agra extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (swiper != null) {
            swiper.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
                ...
                public void onRefresh() {
                    Toast.makeText(Agra.this, "Data Refreshed", Toast.LENGTH_SHORT).show();
                    refreshForecaster();
                }
            });
        }
        ...
        relativeLayout = (RelativeLayout) findViewById(R.id.agra);
...
//        handler.post(refresh);
    ...
    public void moreinfo(View view) {
        Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://en.wikipedia.org/wiki/Agra"));
    ...
    private void refreshForecaster() {
        ...
        if (isNetworkThere()) {
            ...
            double latitude = 27.1767;
            double longitude = 78.0081;
                    ...
                    try {
                        ...
                        if (response.isSuccessful()) {
                            ...
                            a.postDelayed(new Runnable() {
                                @Override
                                public void run() {
                                    Toast.makeText(Agra.this, "What's up something wrong ?", Toast.LENGTH_SHORT).show();
                                }
                            }, 500);
            ...
            Toast.makeText(Agra.this, "Network is Unavailable", Toast.LENGTH_SHORT).show();
        }
    }
