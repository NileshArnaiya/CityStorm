...
public class Palanpur extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_palanpur);
        ...
        relativeLayout = (RelativeLayout) findViewById(R.id.palanpur);
...
//        handler.post(refresh);
    ...
    public void moreinfo(View view) {
        Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://en.wikipedia.org/wiki/Palanpur"));
    ...
    private void refreshForecaster() {
        ...
        if (isNetworkThere()) {
            ...
            double latitude = 24.1741    ;
            double longitude = 72.4331   ;
                        ...
                        if (response.isSuccessful()) {
                            ...
                            runOnUiThread(new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    location.setText("Palanpur, India");
                            ...
                            a.postDelayed(new Runnable() {
                                @Override
                                public void run() {
                                    Toast.makeText(Palanpur.this, "What's up something wrong ?", Toast.LENGTH_SHORT).show();
                                }
                            }, 500);
            ...
            Toast.makeText(Palanpur.this, "Network is Unavailable", Toast.LENGTH_SHORT).show();
        }
    }
