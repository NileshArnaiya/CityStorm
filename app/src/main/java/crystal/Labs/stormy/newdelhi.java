...
public class newdelhi extends AppCompatActivity {
    ...
    public static final String TAG = newdelhi.class.getSimpleName();
...
//    Runnable refresh;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        relativeLayout = (RelativeLayout) findViewById(R.id.newdelhi);
...
//        handler.post(refresh);
    ...
    public void moreinfo(View view) {
        Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://en.wikipedia.org/wiki/Delhi"));
    ...
    private void refreshForecaster() {
        ...
        if (isNetworkThere()) {
                        ...
                        if (response.isSuccessful()) {
                            ...
                            runOnUiThread(new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    humidity.setText(String.format("%.1f", current.getmHumidity())+"%");
                                    rain.setText(String.format("%.1f",current.getmPrecipChance()) + "%" + "");
                                    summary.setText(current.getmSummary() + "");
                                    Drawable drawable = getResources().getDrawable(current.getIconId());
                                    iconview.setImageDrawable(drawable);
                                    location.setText("New Delhi" + ", India");
                            ...
                            a.postDelayed(new Runnable() {
                                @Override
                                public void run() {
                                    Toast.makeText(newdelhi.this, "What's up something wrong ?", Toast.LENGTH_SHORT).show();
                                }
                            }, 500);
            ...
            Toast.makeText(newdelhi.this, "Network is Unavailable", Toast.LENGTH_SHORT).show();
        }
    }
