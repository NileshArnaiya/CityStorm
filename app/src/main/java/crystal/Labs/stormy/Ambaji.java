...
public class Ambaji extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ambaji);
        ...
        relativeLayout = (RelativeLayout) findViewById(R.id.ambaji);
...
//        handler.post(refresh);
    ...
    public void moreinfo(View view) {
        Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://en.wikipedia.org/wiki/Ambaji"));
    ...
    private void refreshForecaster() {
        ...
        if (isNetworkThere()) {
            ...
            double latitude = 24.3310;
            double longitude = 72.8517;
                    ...
                    try {
                        ...
                        if (response.isSuccessful()) {
                            ...
                            a.postDelayed(new Runnable() {
                                @Override
                                public void run() {
                                    Toast.makeText(Ambaji.this, "What's up something wrong ?", Toast.LENGTH_SHORT).show();
                                }
                            }, 500);
            ...
            Toast.makeText(Ambaji.this, "Network is Unavailable", Toast.LENGTH_SHORT).show();
        }
    }
