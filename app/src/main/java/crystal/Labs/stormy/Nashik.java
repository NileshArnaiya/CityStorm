...
public class Nashik  extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        relativeLayout = (RelativeLayout) findViewById(R.id.nashik);
...
//        handler.post(refresh);
    ...
    public void moreinfo(View view) {
        Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://en.wikipedia.org/wiki/Nashik"));
    ...
    private void refreshForecaster() {
        ...
        if (isNetworkThere()) {
                    ...
                    try {
                        ...
                        if (response.isSuccessful()) {
                            ...
                            a.postDelayed(new Runnable() {
                                @Override
                                public void run() {
                                    Toast.makeText(Nashik.this, "What's up something wrong ?", Toast.LENGTH_SHORT).show();
                                }
                            }, 500);
            ...
            Toast.makeText(Nashik.this, "Network is Unavailable", Toast.LENGTH_SHORT).show();
        }
    }
