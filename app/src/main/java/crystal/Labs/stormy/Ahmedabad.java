        ...
        if (swiper != null) {
            swiper.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
                ...
                public void onRefresh() {
                    Toast.makeText(Ahmedabad.this, "Data Refreshed", Toast.LENGTH_SHORT).show();
                    refreshForecaster();
                }
            });
        }
        RelativeLayout relativeLayout;
        relativeLayout = (RelativeLayout) findViewById(R.id.ahmedabad);
...
//        handler.post(refresh);
    ...
    public void moreinfo(View view) {
        Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://en.wikipedia.org/wiki/Ahmedabad"));
    ...
    private void refreshForecaster() {
        ...
        if (isNetworkThere()) {
                        ...
                        if (response.isSuccessful()) {
                            ...
                            runOnUiThread(new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    location.setText("Ahmedabad, India");
                            ...
                            a.postDelayed(new Runnable() {
                                @Override
                                public void run() {
                                    Toast.makeText(Ahmedabad.this, "What's up something wrong ?", Toast.LENGTH_SHORT).show();
                                }
                            }, 500);
            ...
            Toast.makeText(Ahmedabad.this, "Network is Unavailable", Toast.LENGTH_SHORT).show();
        }
    }
