...
public class Allahabad extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_allahabad);
        ...
        if (swiper != null) {
            swiper.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
                ...
                public void onRefresh() {
                    Toast.makeText(Allahabad.this, "Data Refreshed", Toast.LENGTH_SHORT).show();
                    refreshForecaster();
                }
            });
        }
        ...
        relativeLayout = (RelativeLayout) findViewById(R.id.allahabad);
...
//        handler.post(refresh);
    ...
    public void moreinfo(View view) {
        Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://en.wikipedia.org/wiki/Allahabad"));
    ...
    private void refreshForecaster() {
        ...
        if (isNetworkThere()) {
                        ...
                        if (response.isSuccessful()) {
                            ...
                            runOnUiThread(new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    location.setText("Allahabad, India");
                            ...
                            a.postDelayed(new Runnable() {
                                @Override
                                public void run() {
                                    Toast.makeText(Allahabad.this, "What's up something wrong ?", Toast.LENGTH_SHORT).show();
                                }
                            }, 500);
            ...
            Toast.makeText(Allahabad.this, "Network is Unavailable", Toast.LENGTH_SHORT).show();
        }
    }
