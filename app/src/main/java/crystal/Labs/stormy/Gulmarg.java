...
public class Gulmarg extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        relativeLayout = (RelativeLayout) findViewById(R.id.gulmarg);
...
//        handler.post(refresh);
    ...
    public void moreinfo(View view) {
        Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://en.wikipedia.org/wiki/Gulmarg"));
    ...
    private void refreshForecaster() {
        ...
        if (isNetworkThere()) {
            ...
            double latitude = 34.0476     ;
            double longitude = 74.3854;
                        ...
                        if (response.isSuccessful()) {
                            ...
                            runOnUiThread(new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    location.setText("Gulmarg, India");
                            ...
                            a.postDelayed(new Runnable() {
                                @Override
                                public void run() {
                                    Toast.makeText(Gulmarg.this, "What's up something wrong ?", Toast.LENGTH_SHORT).show();
                                }
                            }, 500);
            ...
            Toast.makeText(Gulmarg.this, "Network is Unavailable", Toast.LENGTH_SHORT).show();
        }
    }
