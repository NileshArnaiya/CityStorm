...
public class Darjeeling extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        relativeLayout = (RelativeLayout) findViewById(R.id.darjeeling);
...
//        handler.post(refresh);
    ...
    public void moreinfo(View view) {
        Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://en.wikipedia.org/wiki/Darjeeling"));
    ...
    private void refreshForecaster() {
        ...
        if (isNetworkThere()) {
            ...
            double latitude = 27.0360    ;
            double longitude = 88.2627   ;
                        ...
                        if (response.isSuccessful()) {
                            ...
                            runOnUiThread(new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    location.setText("Darjeeling, India");
                            ...
                            a.postDelayed(new Runnable() {
                                @Override
                                public void run() {
                                    Toast.makeText(Darjeeling.this, "What's up something wrong ?", Toast.LENGTH_SHORT).show();
                                }
                            }, 500);
            ...
            Toast.makeText(Darjeeling.this, "Network is Unavailable", Toast.LENGTH_SHORT).show();
        }
    }
