...
public class Vapi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vapi);
        ...
        relativeLayout = (RelativeLayout) findViewById(R.id.vapi);
...
//        handler.post(refresh);
    ...
    public void moreinfo(View view) {
        Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://en.wikipedia.org/wiki/Vapi"));
    ...
    private void refreshForecaster() {
        ...
        if (isNetworkThere()) {
            ...
            double latitude = 20.3893     ;
            double longitude = 72.9106;
                    ...
                    try {
                        ...
                        if (response.isSuccessful()) {
                            ...
                            a.postDelayed(new Runnable() {
                                @Override
                                public void run() {
                                    Toast.makeText(Vapi.this, "What's up something wrong ?", Toast.LENGTH_SHORT).show();
                                }
                            }, 500);
            ...
            Toast.makeText(Vapi.this, "Network is Unavailable", Toast.LENGTH_SHORT).show();
        }
    }
