...
public class Mumbai extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        relativeLayout = (RelativeLayout) findViewById(R.id.mumbai);
...
//        handler.post(refresh);
    ...
    private void refreshForecaster() {
        ...
        if (isNetworkThere()) {
                    ...
                    try {
                        ...
                        if (response.isSuccessful()) {
                            ...
                            a.postDelayed(new Runnable() {
                                @Override
                                public void run() {
                                    Toast.makeText(Mumbai.this, "What's up something wrong ?", Toast.LENGTH_SHORT).show();
                                }
                            }, 500);
            ...
            Toast.makeText(Mumbai.this, "Network is Unavailable", Toast.LENGTH_SHORT).show();
        }
    }
